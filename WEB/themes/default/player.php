...
<?php if(!empty($PlayerInfo["expire"])) { ?>
         <div class="alert alert-dismissable alert-danger">
            <div><strong>Banned: </strong> <?=$PlayerInfo["bantime"]?></div>
...
<table class="table table-striped table-hover ">
     <tr>
	   <td width="140"><strong>Steam:</strong></td>
	   <td><?=$PlayerInfo["steam"]?> </td>
	 </tr>
     <tr>
	   <td width="140"><strong>Community ID:</strong></td>
	   <td>
     ...
     <tr>
	   <td width="140"><strong>Rank:</strong></td>
	   <td><?=$PlayerInfo["rank"]?></td>
	 </tr>
     <tr>
	   <td width="140"><strong>Connections:</strong></td>
